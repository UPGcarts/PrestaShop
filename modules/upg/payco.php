...
class Payco extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Payco Module');
        $this->description = $this->l('Payco module.');
    ...
    public function hookDisplayAdminOrderRight($params)
    {
        ...
        if($order->module == $this->name) {
            ...
            try{
                ...
                Logger::addLog(
                    $this->l('Payco - Status lookup failed').' '.$order->reference.' '.$e->getMessage(),
                    1,
                    null,
                    null,
                    null, true
