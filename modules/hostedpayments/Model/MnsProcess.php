...
class MnsProcess
{
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_TRANSACTION_STATUS_ACKNOWLEDGEPENDING');
        self::changeOrderStatus($order, $orderStatus);
        return true;
    }
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_TRANSACTION_STATUS_FRAUDPENDING');
        self::changeOrderStatus($order, $orderStatus);
        return true;
    }
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_TRANSACTION_STATUS_CIAPENDING');
        self::changeOrderStatus($order, $orderStatus);
        return true;
    }
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_TRANSACTION_STATUS_MERCHANTPENDING');
        self::changeOrderStatus($order, $orderStatus);
        return true;
    }
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_TRANSACTION_STATUS_INPROGRESS');
        self::changeOrderStatus($order, $orderStatus);
        return true;
    }
    ...
    public static function paid(OrderCore $order, array $mns)
    {
        ...
        $orderStatus = Configuration::get('UPG_RESERVE_PAID');
        ...
        if($autocaptureFlag['autocapture'] && self::canPaymentBeAutocaptured($autocaptureFlag['paymentMethod'])) {
            ...
            $orderStatus = Configuration::get('UPG_AUTOCAPTURE_PAID');
    ...
    {
        $orderStatus = Configuration::get('UPG_RESERVE_PAIDPENDING');
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_PAYMENTFAILED');
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_CHARGEBACK');
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_CLEARED');
    ...
    {
        $orderStatus = Configuration::get('UPG_MNS_INDUNNING');
        self::changeOrderStatus($order, $orderStatus);
