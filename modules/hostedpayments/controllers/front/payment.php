...
class HostedpaymentsPaymentModuleFrontController extends ModuleFrontController
{
    public function initContent()
    {
        ...
        if (!empty($invoiceAddress->company) && Configuration::get('UPG_B2B_ENABLED')) {
            ...
            $this->context->smarty->assign(array(
                ...
                'upg_company_types' => $this->module->getCompanyRegisterTypeOptions()
            ));
            ...
            Tools::redirect($this->context->link->getModuleLink('hostedpayments', 'process'));
        }
