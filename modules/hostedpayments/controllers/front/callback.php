 ...
 * Class HostedpaymentsCallbackModuleFrontController
 */
class HostedpaymentsCallbackModuleFrontController extends ModuleFrontController
{
    ...
    public function postProcess()
    {
        ...
        try {
            ...
            echo json_encode(array('url'=>Context::getContext()->link->getModuleLink('hostedpayments', 'error')));
