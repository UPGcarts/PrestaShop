...
include_once(_PS_MODULE_DIR_ . 'hostedpayments/Model/Mnssave.php');

/**
 * @property Upg module
 * Class HostedpaymentsMnsModuleFrontController
 */
class HostedpaymentsMnsModuleFrontController extends ModuleFrontController
{
    /**
     * @var Hostedpayments $this->module
     */
    public function postProcess()
    {
        ...
        if(empty($orderId)) {
            Logger::addLog(
                'MNS issue: transaction could not be found for '.$data['orderID'],
                1,
                null,
                null,
                null, true
        ...
        try {
            ...
            Logger::addLog(
                'Got mns error'.' '.$data['orderID'].' '.$e->getMessage(),
                1,
                null,
                null,
                null, true
