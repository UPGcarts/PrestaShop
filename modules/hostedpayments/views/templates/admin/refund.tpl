...
<div class="panel">
    <div class="panel-heading">
        ...
        {l s="Hosted Payment Refund"} <span class="badge"></span>
    </div>
    <form id="formUpgRefund"  method="post" action="{$current_index}&amp;vieworder&amp;id_order={$order->id}&amp;token={$smarty.get.token|escape:'html':'UTF-8'}">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr class="current-edit hidden-print">
                        <td>
                            ...
                            <datalist id="capture_id">
                                {foreach from=$captures item=capture}
                                    {if $capture->payment_method == 'Hosted Payments Module'}
                        ...
                        <td class="actions">
                            <button class="btn btn-primary" type="submit" name="submitUpgRefund">
                                {l s='Refund'}
                            </button>
                        </td>
                    </tr>
